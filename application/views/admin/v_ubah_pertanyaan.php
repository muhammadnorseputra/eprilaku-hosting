            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea class="form-control" id="pertanyaan"><?= $pertanyaan['pertanyaan'] ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" id="jawaban_5" value="<?= $pertanyaan['jawaban_5'] ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" id="jawaban_4" value="<?= $pertanyaan['jawaban_4'] ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" id="jawaban_3" value="<?= $pertanyaan['jawaban_3'] ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" id="jawaban_2" value="<?= $pertanyaan['jawaban_2'] ?>">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" id="jawaban_1" value="<?= $pertanyaan['jawaban_1'] ?>">
...
<script>
    ...
    function simpan_pertanyaan() {
        ...
        var id_group_pertanyaan = $('#id_group_pertanyaan').val();

        var id_dd_pertanyaan = $('#id_dd_pertanyaan').val();
        ...
        if (r) {
            ...
            $.post('pertanyaan/proses_pertanyaan', {id_dd_pertanyaan: id_dd_pertanyaan, pertanyaan: pertanyaan, id_group_pertanyaan: id_group_pertanyaan, jawaban_1: jawaban_1, jawaban_2: jawaban_2, jawaban_3: jawaban_3, jawaban_4: jawaban_4, jawaban_5: jawaban_5}, function (hasil) {
